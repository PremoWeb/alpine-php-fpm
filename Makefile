...
buildx-fpm-74:
	...
	@docker buildx build -t premoweb/php-fpm:7.4 --platform linux/amd64,linux/arm64 -f 7.4-fpm/Dockerfile .
.PHONY: buildx-fpm-74

buildx-fpm-80:
	@echo "Building PHP 8.0 Docker images (linux/amd64,linux/arm64)..."
	@docker buildx build -t premoweb/php-fpm:8.0 --platform linux/amd64,linux/arm64 -f 8.0-fpm/Dockerfile .
.PHONY: buildx-fpm-80

buildx-fpm-81:
	@echo "Building PHP 8.1 Docker images (linux/amd64,linux/arm64)..."
	@docker buildx build -t premoweb/php-fpm:8.1 --platform linux/amd64,linux/arm64 -f 8.1-fpm/Dockerfile .
.PHONY: buildx-fpm-81
...
promote:
	@drone build promote premoweb/alpine-php-fpm $(BUILD) $(ENV)
.PHONY: p
