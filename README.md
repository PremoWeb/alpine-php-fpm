# Alpine PHP-FPM [![CI](https://github.com/premoweb/alpine-php-fpm/workflows/CI/badge.svg)](https://github.com/premoweb/alpine-php-fpm/actions?query=workflow%3ACI) [![Docker Image](https://img.shields.io/docker/pulls/premoweb/php-fpm.svg)](https://hub.docker.com/r/premoweb/php-fpm/)
...
![Docker Image Version (tag latest semver)](https://img.shields.io/docker/v/premoweb/php-fpm/7.4) ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/premoweb/php-fpm/7.4)

### PHP 8.0

![Docker Image Version (tag latest semver)](https://img.shields.io/docker/v/premoweb/php-fpm/8.0) ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/premoweb/php-fpm/8.0)

### PHP 8.1

![Docker Image Version (tag latest semver)](https://img.shields.io/docker/v/premoweb/php-fpm/8.1) ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/premoweb/php-fpm/8.1)
...
🐳 Available on Docker Hub → [hub.docker.com/r/premoweb/php-fpm](https://hub.docker.com/r/premoweb/php-fpm/)

```sh
docker pull premoweb/php-fpm:7.4
# Or
docker pull premoweb/php-fpm:8.0
# Or
docker pull premoweb/php-fpm:8.1
```

### Dockerfile

```Dockerfile
FROM premoweb/php-fpm:7.4
# Or
FROM premoweb/php-fpm:8.0
# Or
FROM premoweb/php-fpm:8.1
```
...
```sh
docker run --rm -p 8088:80 premoweb/php-fpm:8.1 sh -c "echo '<?php phpinfo();' > index.php; php -S [::]:80 -t ."
# Or
docker run --rm -p 8088:80 premoweb/php-fpm:8.0 sh -c "echo '<?php phpinfo();' > index.php; php -S [::]:80 -t ."
# Or
docker run --rm -p 8088:80 premoweb/php-fpm:7.4 sh -c "echo '<?php phpinfo();' > index.php; php -S [::]:80 -t ."
```
...
Feel free to send a [pull request](https://github.com/premoweb/alpine-php-fpm/pulls) or file some [issue](https://github.com/premoweb/alpine-php-fpm/issues).
...
Feel free to send some [Pull request](https://github.com/premoweb/alpine-php-fpm/pulls) or [issue](https://github.com/premoweb/alpine-php-fpm/issues).

## License

This work is primarily distributed under the terms of both the [MIT license](LICENSE-MIT) and the [Apache License (Version 2.0)](LICENSE-APACHE).

© 2020-present [PremoWeb](https://git.io/premoweb)
